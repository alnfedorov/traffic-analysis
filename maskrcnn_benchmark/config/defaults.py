...
# Focal loss for RPN
_C.MODEL.RPN.USE_FOCAL = False
_C.MODEL.RPN.FOCAL = CN()
_C.MODEL.RPN.FOCAL.LOSS_ALPHA = 0.25
_C.MODEL.RPN.FOCAL.LOSS_GAMMA = 2.0
...
_C.MODEL.ROI_HEADS.USE_CASCADE_POOLING = False
...
# Focal loss
_C.MODEL.ROI_BOX_HEAD.USE_FOCAL = False
_C.MODEL.ROI_BOX_HEAD.FOCAL = CN()
_C.MODEL.ROI_BOX_HEAD.FOCAL.LOSS_ALPHA = 0.25
_C.MODEL.ROI_BOX_HEAD.FOCAL.LOSS_GAMMA = 2.0
...
# Focal loss
_C.MODEL.ROI_MASK_HEAD.USE_FOCAL = False
_C.MODEL.ROI_MASK_HEAD.FOCAL = CN()
_C.MODEL.ROI_MASK_HEAD.FOCAL.LOSS_ALPHA = 0.25
_C.MODEL.ROI_MASK_HEAD.FOCAL.LOSS_GAMMA = 2.0
